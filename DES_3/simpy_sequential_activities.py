...
class Patient:
    def __init__(self, p_id):
        ...
        self.q_time_registration = pd.NA # NEW
...
class Param:
    def __init__(
        ...
        mean_registration_time = 3, # NEW
        sd_registration_time = 0.5, # NEW
        mean_nurse_consult_time = 6,
        sd_nurse_consult_time = 1,
        num_receptionists = 1, # NEW
        num_nurses = 1,
        sim_duration = 120,
        num_replications = 5
    ):
        self.mean_patient_inter = mean_patient_inter
        self.mean_registration_time = mean_registration_time # NEW
        self.sd_registration_time = sd_registration_time # NEW
        self.mean_nurse_consult_time = mean_nurse_consult_time
        self.sd_nurse_consult_time = sd_nurse_consult_time
        self.num_receptionists = num_receptionists # NEW
...
class Model:
    def __init__(self, param, replication_id):
        ...
        self.mean_q_time_registration = pd.NA # NEW
        self.sd_q_time_registration = pd.NA # NEW
        self.perc_90_q_time_registration = pd.NA # NEW
...
class Trial:
    def __init__(self, param):
        ...
        self.trial_mean_q_time_registration = pd.NA # NEW
        self.trial_sd_q_time_registration = pd.NA # NEW
        self.trial_perc_90_q_time_registration = pd.NA # NEW
        self.trial_mean_q_time_nurse = pd.NA
        self.trial_sd_q_time_nurse = pd.NA
        self.trial_perc_90_q_time_nurse = pd.NA
        self.ci_lower_q_time_registration = pd.NA # NEW
        self.ci_upper_q_time_registration = pd.NA # NEW
        self.se_q_time_registration = pd.NA # NEW
...
what_if_params = Param(num_nurses=2, num_receptionists=2) # NEW
