...
class Param:
    def __init__(
        ...
        self.results_collection_period = results_collection_period # NEW
        self.warm_up_period = warm_up_period # NEW
        self.sim_duration = warm_up_period + results_collection_period # NEW
